...
import com.example.reservation.jwt.JwtAuthenticationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .and()
                .authorizeRequests().antMatchers("/assets/**","/css/**","/fonts/**","/images/**","/vendor/**","/js/**").permitAll()
                .and()
                .authorizeRequests()// 다음 리퀘스트에 대한 사용권한 체크
    ...
    public WebSecurityCustomizer webSecurityCustomizer() { //시큐리티 filter 제외, 그러나 OncePerRequestFilter는 시큐리티 필터가 아니라서 로직실행
        ...
        return (web) ->
                web.ignoring().mvcMatchers(PUBLIC_URLS)
                        .and()
                        .ignoring().antMatchers("/assets/**","/css/**","/fonts/**","/images/**","/vendor/**","/js/**");
