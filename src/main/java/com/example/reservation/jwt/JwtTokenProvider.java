...
public class JwtTokenProvider {// 토큰 생성, 검증 하는 객체
    ...
    public String makeJwtToken(AccountSignUpRequest user) {//토큰 생성
        Date now = new Date();
        ...
        return Jwts.builder()
                ...
                .claim("id", user.getUsrId())
                .signWith(SignatureAlgorithm.HS256, jwtProperties.getSecretKey())
                .compact();
    }

    public AccountSignUpRequest getUserDtoOf(String authorizationHeader) {
        ...
        try {
            ...
            return new AccountSignUpRequest(claims);
        }catch (Exception e){
